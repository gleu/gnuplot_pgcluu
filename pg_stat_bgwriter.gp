...
plot 'pgcluu_csv/pg_stat_bgwriter.csv' using 1:(shift_cp($6), $0 < 1 ? NaN : cp1 - cp2) title 'checkpointer' with lines ls 101 \
     , '' using 1:(shift_bw($7), $0 < 1 ? NaN : bw1 - bw2) title 'writer process' with lines ls 102 \
     , '' using 1:(shift_be($9), $0 < 1 ? NaN : be1 - be2) title 'backends'       with lines ls 103
...
plot 'pgcluu_csv/pg_stat_bgwriter.csv' using 1:(shift_bw($7), $0 < 1 ? NaN : bw1 - bw2) title 'Cleaned blocks' with lines ls 101 \
   , '' using 1:(shift_mw($8), $0 < 1 ? NaN : mw1 - mw2) axes x1y2 title 'Max written limit reached' with lines ls 102
...
plot 'pgcluu_csv/pg_stat_bgwriter.csv' using 1:(shift_ba($11), $0 < 1 ? NaN : ba1 - ba2) with lines ls 101
